    ...
    <form action="" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="adminname" value="" size="80" class="inpMain" required="required"/>
       </td>
      </tr>
       <tr>
       <td width="90" align="right">登陆密码</td>
       <td>
        <input type="text" name="adminpassword" value="" size="80" class="inpMain" required="required"/>
       </td>
      </tr>
      <tr>
