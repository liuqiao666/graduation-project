...
<div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
   <h3>评论管理
    <a href="commentscontrol.php" class="btn" style="margin-left: 300px;"><h4>期刊评论</h4></a>
 	<a href="commentsharing.php" class="btn" style="margin-left: 100px;"><h4>分享圈评论</h4></a></h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
      <th width="55" align="center">编号</th>
	...
	?>
      ...
      <td align="center"><?php echo $row->praise;?></td>    
      <td align="center">    	
      	<a href="shancommentsharing.php?username=<?php echo $row->username;?>&content=<?php echo $row->content;?>" onclick="return confirm('确认删除?!');" class="btn">删除</a>
      </td>    
     </tr>
    <?php 
	}
