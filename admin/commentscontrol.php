...
<div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
   <h3>评论管理
	...
	?>
      ...
      <td align="center">    	
      	<a href="shancomment.php?username=<?php echo $row->username;?>&content=<?php echo $row->content;?>" onclick="return confirm('确认删除?!');" class="btn">删除</a>
      </td>    
     </tr>
    <?php 
	}
